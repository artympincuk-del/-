...
# Anti-abuse: the referral bonus isn't paid at /start anymore, only once the
# referred account has sent this many real messages (proves it's not just a
# fake account created to farm the referrer bonus).
